...
export default class XmppConnection extends Listenable {
  ...
  static readonly Status: StropheStatus
  constructor(options: {
  ...
  addConnectionPlugin: (
    name: string,
    plugin: ConnectionPluginListenable
  ) => void
  ...
  sendIQ: (
    elem: unknown,
    callback: (params: unknown) => unknown,
    errback: (params: unknown) => unknown,
    timeout: (params: unknown) => unknown
  ) => number | undefined // TODO:
