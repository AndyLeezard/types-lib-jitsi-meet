...
export default class JitsiConference {
  ...
  ) => Promise<unknown | JitsiTrackError>
  getRole: () => string
  ...
  onIncomingCall: (
    jingleSession: unknown,
    jingleOffer: unknown,
    now: unknown
  ) => void // TODO: unknown = JingleSessionPC which doesn't exist
  onCallEnded: (
    jingleSession: unknown,
